import BellevuePark0 from "./BellevuePark/0.png";
import BellevuePark1 from "./BellevuePark/1.png";
import BellevuePark2 from "./BellevuePark/2.png";
import BellevuePark3 from "./BellevuePark/3.png";
import BellevuePark4 from "./BellevuePark/4.png";
import BellevuePark5 from "./BellevuePark/5.png";
import BigScreenLedges0 from "./BigScreenLedges/0.png";
import BigScreenLedges1 from "./BigScreenLedges/1.png";
import BigScreenLedges2 from "./BigScreenLedges/2.png";
import BigScreenLedges3 from "./BigScreenLedges/3.png";
import BigScreenLedges4 from "./BigScreenLedges/4.png";
import BigScreenLedges5 from "./BigScreenLedges/5.png";
import Brick0 from "./Brick9/0.png";
import Brick1 from "./Brick9/1.png";
import Brick2 from "./Brick9/2.png";
import Brick3 from "./Brick9/3.png";
import Brick4 from "./Brick9/4.png";
import Brick5 from "./Brick9/5.png";
import Brick6 from "./Brick9/6.png";
import BryantPark0 from "./BryantPark/0.png";
import BryantPark1 from "./BryantPark/1.png";
import BryantPark2 from "./BryantPark/2.png";
import BryantPark3 from "./BryantPark/3.png";
import BryantPark4 from "./BryantPark/4.png";
import BryantPark5 from "./BryantPark/5.png";
import BryantPark6 from "./BryantPark/6.png";
import BryantPark7 from "./BryantPark/7.png";
import BryantPark8 from "./BryantPark/8.png";
import CarWashBump0 from "./CarWashBump/0.png";
import CarWashBump1 from "./CarWashBump/1.png";
import CBS0 from "./cbs/0.png";
import CBS1 from "./cbs/1.png";
import CBS2 from "./cbs/2.png";
import CBS3 from "./cbs/3.png";
import CBS4 from "./cbs/4.png";
import CBS5 from "./cbs/5.png";
import CBS6 from "./cbs/6.png";
import CBS7 from "./cbs/7.png";
import CBS8 from "./cbs/8.png";
import ColumbusCircle0 from "./ColumbusCircle/0.png";
import ColumbusCircle1 from "./ColumbusCircle/1.png";
import ColumbusCircle2 from "./ColumbusCircle/2.png";
import ColumbusCircle3 from "./ColumbusCircle/3.png";
import ColumbusCircle4 from "./ColumbusCircle/4.png";
import ColumbusCircle5 from "./ColumbusCircle/5.png";
import ColumbusCircle6 from "./ColumbusCircle/6.png";
import FakeBarcelonaLedge0 from "./FakeBarcelonaLedge/0.png";
import FakeBarcelonaLedge1 from "./FakeBarcelonaLedge/1.png";
import FakeBarcelonaLedge2 from "./FakeBarcelonaLedge/2.png";
import FedEx0 from "./FedEx/0.png";
import FedEx1 from "./FedEx/1.png";
import FedEx2 from "./FedEx/2.png";
import FedEx3 from "./FedEx/3.png";
import FedEx4 from "./FedEx/4.png";
import FedEx5 from "./FedEx/5.png";
import FedEx6 from "./FedEx/6.png";
import FedEx7 from "./FedEx/7.png";
import FedEx8 from "./FedEx/8.png";
import FedEx9 from "./FedEx/9.png";
import FiveThenThree0 from "./FiveThenThree/0.png";
import FiveThenThree1 from "./FiveThenThree/1.png";
import FiveThenThree2 from "./FiveThenThree/2.png";
import IBM0 from "./IBMLedges/0.png";
import IBM1 from "./IBMLedges/1.png";
import IBM2 from "./IBMLedges/2.png";
import IBM3 from "./IBMLedges/3.png";
import JohnJayStep0 from "./JohnJayStep/0.png";
import JohnJayStep1 from "./JohnJayStep/1.png";
import PaineWebber0 from "./PaineWebber/0.png";
import PaineWebber1 from "./PaineWebber/1.png";
import PaineWebber2 from "./PaineWebber/2.png";
import QueensboroBridgeLedges0 from "./QueensboroBridgeLedges/0.png";
import QueensboroBridgeLedges1 from "./QueensboroBridgeLedges/1.png";
import QueensboroBridgeLedges2 from "./QueensboroBridgeLedges/2.png";
import QueensboroBridgeLedges3 from "./QueensboroBridgeLedges/3.png";
import QueensboroBridgeLedges4 from "./QueensboroBridgeLedges/4.png";
import QueensboroBridgeLedges5 from "./QueensboroBridgeLedges/5.png";
import QueensboroBridgeLedges6 from "./QueensboroBridgeLedges/6.png";
import QueensboroBridgeLedges7 from "./QueensboroBridgeLedges/7.png";
import QueensboroBridgeLedges8 from "./QueensboroBridgeLedges/8.png";
import QueensboroBridgeLedges9 from "./QueensboroBridgeLedges/9.png";
import Seagram0 from "./Seagram/0.png";
import Seagram1 from "./Seagram/1.png";
import Seagram2 from "./Seagram/2.png";
import Seagram3 from "./Seagram/3.png";
import Seagram4 from "./Seagram/4.png";
import SuarezRail0 from "./SuarezRail/0.png";
import SuarezRail1 from "./SuarezRail/1.png";
import SuarezRail2 from "./SuarezRail/2.png";
import SuarezRail3 from "./SuarezRail/3.png";
import TimesSquare0 from "./TimesSquare/0.png";
import TimesSquare1 from "./TimesSquare/1.png";
import TimesSquare2 from "./TimesSquare/2.png";
import TimesSquare3 from "./TimesSquare/3.png";
import TimesSquare4 from "./TimesSquare/4.png";
import UNHubba0 from "./UNHubba/0.png";
import UNHubba1 from "./UNHubba/1.png";
import UNHubba2 from "./UNHubba/2.png";
import UNHubba3 from "./UNHubba/3.png";
import VirtualRealityBump0 from "./VirtualRealityBump/0.png";
import VirtualRealityBump1 from "./VirtualRealityBump/1.png";
import VirtualRealityBump2 from "./VirtualRealityBump/2.png";
import VirtualRealityBump3 from "./VirtualRealityBump/3.png";
import VirtualRealityBump4 from "./VirtualRealityBump/4.png";
import VirtualRealityBump5 from "./VirtualRealityBump/5.png";
...
const spots = [
	...
	},
	{
		...
		bust: {
			level: 4,
			status:
				"Skateboarding is forbidden by park rules. The park is filled with a million people at any reasonable hour on warm days, but is calmer at night. Cops will sometimes come through and tell you to leave. You may get a ticket for skating — or if you’re lucky — put in a chokehold and pepper sprayed.",
		},
	...
	},
	{
		...
		bust: {
			level: 4,
			status:
				"There are “No Skateboarding” signs posted. Cameras or an outdoor guard will inevitably spot you and tell you to leave. Weekend spot.",
		},
	...
	},
	{
		...
		bust: {
			level: 1,
			status:
				"You’re technically not allowed to skate here, but nobody from the adjacent buildings bothers you considering it’s a pretty shitty park. The gate is closed at night — and sometimes on random days for no reason.",
		},
		location: {
			latitude: 40.74016180670981,
	...
	},
	{
		...
		bust: {
			level: 4,
			status:
				"There are “No Skateboarding” signs posted. The building closes down after 10 P.M., but security may still come out and tell you to leave.",
		},
		location: {
			latitude: 40.762022192115545,
			longitude: -73.972893457809,
	...
	},
	{
		...
		bust: {
			level: 5,
			status:
				"You are not allowed to skate on school property. Better on nights and weekends.",
		},
		location: {
			latitude: 40.77175813200365,
			longitude: -73.99005310223184,
	...
	},
	{
		...
		bust: {
			level: 5,
			status:
				"There are “No Skateboarding” signs posted. Oftentimes, security stands outside right in front of the spot. They’ll tell you to leave the second they see you. The benches are also often covered in oily street cart food residue, so be careful.",
		},
		location: {
			latitude: 40.76189456814171,
			longitude: -73.97962213175006,
	...
	},
	{
		...
		bust: {
			level: 5,
			status:
				"There’s a tennis club that is open throughout the summer adjacent to the concrete ledge. They may ask you to leave if you skate here. Nobody hassles you at the spot across the street.",
		},
		location: {
			latitude: 40.75905695631634,
			longitude: -73.9597761866992,
			text: "The concrete ledge is on 59th and Sutton Place. The other ledges are down the hill and across the street, on the overpass.",
		},
		images: {
			0: QueensboroBridgeLedges0,
			1: QueensboroBridgeLedges1,
			2: QueensboroBridgeLedges2,
			3: QueensboroBridgeLedges3,
			4: QueensboroBridgeLedges4,
			5: QueensboroBridgeLedges5,
			6: QueensboroBridgeLedges6,
			7: QueensboroBridgeLedges7,
	...
	},
	{
		...
		bust: {
			level: 4,
			status:
				"Skateboarding is forbidden in the plaza, and everything is in front of the security window. They will tell you to leave as soon as they spot you.",
		},
		location: {
			latitude: 40.75843864966537,
			longitude: -73.97297734110575,
	...
	},
	{
		...
		bust: {
			level: 5,
			status:
				"Skateboarding is forbidden in the plaza. Better at night, though security will still kick you out sooner rather than later.",
		},
		location: {
			latitude: 40.761952939691795,
			longitude: -73.97065572889301,
	...
	},
	{
		...
		bust: {
			level: 5,
			status:
				"You are not allowed to skate anywhere in Times Square. There is a precinct in the center of it, and the cops will typically tell you to leave once they spot you. However, people have been known to get lucky — this place has ramped up in coverage over the years — though there is no exact formula for luck here.",
		},
		location: {
			latitude: 40.75696771426574,
			longitude: -73.98611027111515,
			text: "43rd and Broadway.",
		},
		images: {
			0: TimesSquare0,
			1: TimesSquare1,
	...
	},
	{
		...
		bust: {
			level: 5,
			status:
				"Skateboarding is forbidden in the park. The Parks Department will tell you to leave if they see you.",
		},
		location: {
			latitude: 40.753207376753664,
			longitude: -73.96991755105256,
	...
	},
	{
		...
		bust: {
			level: 5,
			status: "This place was put on earth to make life worth living.",
		},
		location: {
			latitude: 40.74529791465033,
			longitude: -73.97147083678115,
			text: "37th Street between First Avenue and the FDR Drive.",
		},
		images: {
			0: VirtualRealityBump0,
			1: VirtualRealityBump1,
			2: VirtualRealityBump2,
			3: VirtualRealityBump3,
