...
function Popup({
	...
	return (
		<div className="absolute flex  text-center bg-black bg-opacity-50 z-50">
			<div className="top-0 left-0 right-0 bottom-0 bg-white p-4 rounded-lg shadow-lg my-4 md:mx-40 ">
