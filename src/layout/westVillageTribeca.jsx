...
function WestVillageTribeca() {
	useEffect(() => {}, []);
	if (!spots.WestVillageTribeca) {
	...
	return (
		<>
			...
			>
				{spots.WestVillageTribeca.map((res, index) => (
					<div
					...
					>
						...
						<p className="text-gray-600 font-bold text-sm">{res.bust.status}</p>
						<img src={skateIcon} />
...
export default WestVillageTribeca;
